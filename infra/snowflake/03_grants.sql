...
-- ---------------------------------------------------------------------------
-- Observer: use only the application warehouse and the operational view.
-- ---------------------------------------------------------------------------
...
-- The transformer materializes bounded operational aggregates. These
-- database roles expose Account Usage metadata to that role, not to readers.
